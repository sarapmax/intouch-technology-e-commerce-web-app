		...
		<div class="outer-page">
			 ...
			 <div class="login-page">
					...
					<ul class="nav nav-tabs nav-justified">
					  <li class="active"><a href="#login" data-toggle="tab" class="br-orange"><i class="fa fa-sign-in"></i> Sign In</a></li>
					  <li><a href="#register" data-toggle="tab" class="br-orange"><i class="fa fa-pencil"></i> Sign Up</a></li>
					</ul>
